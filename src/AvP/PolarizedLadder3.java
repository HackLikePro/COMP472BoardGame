...
public class PolarizedLadder3 extends JFrame implements MouseListener, MouseMotionListener {
	...
	public PolarizedLadder3() {
		...
		int initrow = 4, initcol = 7;
		this.chessBoard.getComponent( initcol + initrow * 14).setBackground(Color.yellow);
		PolarizedLadder3.board_init[initcol + initrow * 14] = "yellow";
		store2DResult(PolarizedLadder3.board_init, 0, 0);
	}
	...
	public void mousePressed(MouseEvent arg0) {
		...
		if (PolarizedLadder3.board_init[clickedsquare].equals("1")) {
			this.chessBoard.getComponent(clickedsquare).setBackground(Color.black);
			PolarizedLadder3.board_init[clickedsquare] = "black";
			// rolecount++;
			store2DResult(PolarizedLadder3.board_init, y, x);
			...
			PolarizedLadder3.board_init[colorChange] = "yellow";
			store2DResult(PolarizedLadder3.board_init, y, x);
	...
	public static void main(String[] args) {
		JFrame frame = new PolarizedLadder3();
